...
export function DemographicsWidget() {
  return (
    <div className="bg-white rounded-[32px] p-6 shadow-[0_2px_20px_rgba(0,0,0,0.03)] border border-border/40 flex-1 flex flex-col">
      ...
      <div className="relative w-full h-[240px] flex items-end justify-center mb-4 overflow-visible">
         {/* Concentric circles offset to the bottom */}
         <div className="absolute bottom-0 w-[220px] h-[220px] rounded-full bg-brand/10 border border-brand/20 flex flex-col items-center justify-start pt-6">
            <span className="text-brand font-semibold text-sm">1,200</span>
